            ...
            <div className="row">
              <div className="col-lg-8">
                <div className="header-text">
                  <h2>El arte <em>de</em> crear con <em>maderas</em></h2>
                  <div className="div-dec"></div>
                  <h4 style={{ color: 'white' }}>
                    Todo en muebles: Armarios,mesas para cocina,bases para cama, sillas.
                    Maderas selectas de Pino, Caoba, Encino, Maple, Cedro</h4>
        ...
        <div className="col-lg-5">
          ...
          <form id="calculate" action="" method="get">
            <div className="row">
              ...
              <div className="col-lg-12">
                <fieldset>
                  <label htmlFor="chooseOption" className="form-label">Razon</label>
                  <select
  name="Category"
...
>
  ...
  <option value="Crypto Investment">Inventario</option>
              ...
              <div className="col-lg-12">
                <fieldset>
                  <button type="submit" id="form-submit" className="orange-button">Enviar</button>
                </fieldset>
              </div>
            </div>
          </form>
  ...
  <footer>
    <div className="container">
      <div className="row">
        <div className="col-lg-12">
          <p>Copyright © 2022 IT SOFTECH Co., Ltd. All Rights Reserved. </p>
