      ...
      <section className="container">
        <div className="row">
          <div className="col-lg-9 col-md-7">
            {data ? (
              data.length === 0 ? (
                <div className="card shadow-lg bg-white rounded container">
                  <div className="card-header">
                    <h5>Productos</h5>
                  </div>
                  <div className="card-body text-center">
                    <img
                      src="../../../assets/images/bolsas-de-compra.png"
                    ...
                    {data.map((producto) => (
                      <div key={producto.id} className="card-body">
                        <div className="d-flex align-items-center">
                          ...
                          />
                          <p
                            className="card-title text-black font-weight-bold"
                          ...
                          >
                            ...
                            <input
                              ...
                              style={{ width: "3em", border: "0px" }}
                              value={producto.cantidadAñadida}
                              readOnly
                            />
                            <button
                              className="btn col-1"
                          ...
                          >
                            <small className="text-muted">
                              anch {producto.ancho} m | larg {producto.largo} m | alt {producto.altura} m
                            </small>
                          </p>
                          <p
                          ...
                          >
                            ${(
                              producto.total * producto.cantidadAñadida
                            ).toFixed(2)} MXN
                          </p>
                          <button
              ...
              <div className="card-body">
                {total > 0 ? (
                  <div>
                    ...
                    <div className="d-flex align-items-center mb-4">
                      <p
                        style={{ marginRight: "10em", fontWeight: "bold" }}
                      >
                        Total
                      </p>
                  ...
                  <p>
                    Agrega a tu carrito para obtener tu resumen de compra
                  </p>
                )}
              </div>
            </div>
